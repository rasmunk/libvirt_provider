...
def create_group(parser):
    ...
    instance_group.add_argument("name", action=PositionalArgumentsAction, help="The name of the instance")
    instance_group.add_argument("disk_image_path", action=PositionalArgumentsAction, help="The path to the disk image")
